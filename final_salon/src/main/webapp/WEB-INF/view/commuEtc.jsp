...
<body>
	...
	<div class="pageee">
	   <c:if test="${pv.startPage > 1}">
		  <a href="etc.do?currentPage=${pv.startPage - pv.blockPage}" >
		  <span id="numberr">이전</span>
		  </a>
	   </c:if>
	   
	   <c:forEach var="i" begin="${pv.startPage}" end="${pv.endPage}">
		  <a href="etc.do?currentPage=${i}" id="numberr">${i}</a>
	   </c:forEach>
	   
	   <c:if test="${pv.endPage < pv.totalPage}">
		  <a href="etc.do?currentPage=${pv.endPage + pv.blockPage}">

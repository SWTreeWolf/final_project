...
<body>
	...
	<div class="wrap2">
	  <div>게시글 : ${makeupcnt}</div>
	  <div class="smallwrap">
	   <div class="container">
	      <div class="cate">
	        <p><a href="commu.do">전체</a></p><p>ㅣ</p>
	        <p><a href="skin.do">피부고민</a></p><p>ㅣ</p>
	        <p id="jun"><a href="makeup.do">메이크업</a></p><p>ㅣ</p>
	...
	<c:forEach items="${makeup}" var="com">
	<div class="wrap3">
	   <div class="smwrap">
	...
	<div class="pageee">
	   <c:if test="${pv.startPage > 1}">
		  <a href="makeup.do?currentPage=${pv.startPage - pv.blockPage}" >
		  <span id="numberr">이전</span>
		  </a>
	   </c:if>
	   
	   <c:forEach var="i" begin="${pv.startPage}" end="${pv.endPage}">
		  <a href="makeup.do?currentPage=${i}" id="numberr">${i}</a>
	   </c:forEach>
	   
	   <c:if test="${pv.endPage < pv.totalPage}">
		  <a href="makeup.do?currentPage=${pv.endPage + pv.blockPage}">

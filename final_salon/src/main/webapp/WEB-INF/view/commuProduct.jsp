...
<body>
	  ...
	  <div class="smallwrap">
	   <div class="container">
	      <div class="cate">
	        ...
	        <p id="jun"><a href="product.do">제품정보</a></p><p>ㅣ</p>
	...
	<c:forEach items="${product}" var="com">
	<div class="wrap3">
	   <div class="smwrap">
	...
	<div class="pageee">
	   <c:if test="${pv.startPage > 1}">
		  <a href="product.do?currentPage=${pv.startPage - pv.blockPage}" >
		  <span id="numberr">이전</span>
		  </a>
	   </c:if>
	   
	   <c:forEach var="i" begin="${pv.startPage}" end="${pv.endPage}">
		  <a href="product.do?currentPage=${i}" id="numberr">${i}</a>
	   </c:forEach>
	   
	   <c:if test="${pv.endPage < pv.totalPage}">
		  <a href="product.do?currentPage=${pv.endPage + pv.blockPage}">

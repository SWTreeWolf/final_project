...
<body>
	<div class="wrap2345">
	    <div class="space"></div>
		<p id="subisubi">Salon de Barbie Community</p>
	      ...
	      <div class="subbb"></div>
	        ...
	        <c:forEach items="${toplist}" var="com">
	          <div class="boxxx">
	             ...
	             ${com.content}
	             <%-- <c:if test="${!fn:contains(content,'<img')}"></c:if> --%>
	             </div>
	...
	<div class="wrap2">
	  ...
	  <div class="smallwrap">
	   <div class="container">
	      <div class="cate">
	        <p id="jun"><a href="commu.do">전체</a></p> <p>ㅣ</p>
	        <p><a href="skin.do">피부고민</a></p> <p>ㅣ</p>
	   ...
	   <div class="search">
	     ...
	     <a id="searchBtn" class="searchimage"><img src="images/searchicon.jpg"/ class="searchBtnnn"></a>
	   </div>
	...
	<div class="pageee">
	   <c:if test="${pv.startPage > 1}">
		  <a href="commu.do?currentPage=${pv.startPage - pv.blockPage}" >
		  <span id="numberr">이전</span>
		  </a>
	   </c:if>
	   
	   <c:forEach var="i" begin="${pv.startPage}" end="${pv.endPage}">
		  <a href="commu.do?currentPage=${i}" id="numberr">${i}</a>
	   </c:forEach>
	   
	   <c:if test="${pv.endPage < pv.totalPage}">
		  <a href="commu.do?currentPage=${pv.endPage + pv.blockPage}">

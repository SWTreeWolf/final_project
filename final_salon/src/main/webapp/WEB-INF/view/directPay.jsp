      ...
      <div class="content">
         ...
         <div class="orderPayWrap">
            ...
            <div class="orderPayCont mt50">
                              ...
                              <ul class="ordPrdList">
                                 ...
                                 <li class="prdList">
                                    ...
                                    <input type="hidden" id="goods_code" value="${dto.goods_code }"/>
                                       <a> <img src="${requestScope.dto.goods_main }" alt="제품이미지">
                                       </a>
                                    </div>
                                    <div class="prdInfo">
                                       <div class="prdDetail">
                                          <p class="prdName">
                                             <a> ${requestScope.dto.goods_name } </a>
                                          </p>
                                          <!-- <span class="prdOpt"></span> -->
                                          <c:set var="tot_count" value="0" />
                                          <c:if test="${!empty dto.goods_color}">
                                          <c:forEach   items="${dto.option_color_img}" var="color" varStatus="status">
                                          ...
                                          <dl class="choiceOpt mt10">
                                             ...
                                             <dd class="opt_mt10">
                                                ...
                                                <ul class="ul10">
                                                   <c:forEach items="${dto.option_color_img}" var="color"
                                                      varStatus="status">
                                                      <li class="li10">
                                                      ...
                                                      <span class="optColor"><img
                                                         ...
                                                         <span class="optName" style="line-height: 20px;"> <em
                                                            class="optCount"><span class="opt_counts">${dto.option_count[status.index]}</span>개</em>
                                       ...
                                       <li>
                                          ...
                                          <div id="dlvBox">
                                             <div class="textForm js-label" id="dlvMsgDisp">
                                                <label for="dlvMsg" class=""></label> <select
                                                   id="dlvMsg">
               ...
               <div id="payListWrap">
                  <dl id="totalPriceBox">
                  <c:if test="${tot_price<10000 }">
                  	 <c:set var="DlvPrice" value="2500" />
                  </c:if>
                     <c:set var="final_price" value="${tot_price+ DlvPrice}" />
                     <dt class="h5_title">
                        ...
                        <ul>
                           <li>
                              <p id="payTxt">주문금액</p> <strong><span
                                 id="lastOrderPrice">${tot_price }</span> 원</strong>
                           ...
                           <li>
                              <p id="payTxt">사용 포인트</p> 
                              	<c:if test="${point >= 5000}">
                              		<input type="text" id="pos_point" onclick="onlyNumber(this)"/>
                              	</c:if>
                              	<c:if test="${point < 5000}">

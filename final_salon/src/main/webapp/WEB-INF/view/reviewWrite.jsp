...
<body>
	...
	<input type="hidden" id="goods_code" name="goods_code" value="${prod.goods_code }"/>
		<div class="wrap">
			<div class="line"></div>
			...
			<div id="heart">
				<a href="#" class="a"><img src="images/heart4.png"
					class="empheart"></a> <a href="#" class="a"><img
					src="images/empheart.png" class="empheart"></a> <a href="#"
					class="a"><img src="images/empheart.png" class="empheart"></a>
				<a href="#" class="a"><img src="images/empheart.png"
					class="empheart"></a> <a href="#" class="a"><img
					src="images/empheart.png" class="empheart"></a>
			</div>
			...
			<input type="hidden" name="id" id="id" value="${sessionScope.dto.id }" /> 
			<input type="hidden" name="nickname" id="nickname" value="${sessionScope.dto.nickname }" /> 
		</div>
	</form>
</body>
</html>